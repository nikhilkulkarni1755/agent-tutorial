...
// const editFileTool = {
//   name: 'edit_file',
//     description: 'Replaces the contents of a file with new content. Use this to apply edits.',
//     parameters: {
//       type: 'object',
//       properties: {
//         path: { type: 'string', description: 'The file path to edit' },
//         new_content: { type: 'string', description: 'The full new content to write to the file' },
//       },
//       required: ['path', 'new_content'],
//     },
//     function: async ({ path: filePath, new_content }) => {
